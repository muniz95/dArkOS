...
sudo cp libs/bluetooth/scripts/Bluetooth.sh Arkbuild/opt/system/
sudo cp libs/bluetooth/scripts/bt* Arkbuild/usr/local/bin/
sudo cp libs/bluetooth/scripts/watchforbtaudio.sh Arkbuild/usr/local/bin/
sudo cp libs/bluetooth/systemd/* Arkbuild/etc/systemd/system/
sudo mkdir -p Arkbuild/usr/share/alsa/alsa.conf.d/
sudo cp --remove-destination libs/bluetooth/config/20-bluealsa.conf Arkbuild/usr/share/alsa/alsa.conf.d/
