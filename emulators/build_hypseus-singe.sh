...
if [ -f "Arkbuild_package_cache/${CHIPSET}/hypseus-singe.tar.gz" ] && [ "$(cat Arkbuild_package_cache/${CHIPSET}/hypseus-singe.commit)" == "$(curl -s https://api.github.com/repos/DirtBagXon/hypseus-singe/commits/sdl2 | jq -r '.sha')" ]; then
