...
sudo cp -L emulators/ppsspp/gamecontrollerdb.txt.${UNIT} Arkbuild/opt/ppsspp-2021/assets/gamecontrollerdb.txt
sudo cp -L emulators/ppsspp/configs/backupforromsfolder/ppsspp/PSP/SYSTEM/ppsspp.ini.go.${UNIT} Arkbuild/opt/ppsspp-2021/backupforromsfolder/ppsspp/PSP/SYSTEM/ppsspp.ini.go
sudo cp -L emulators/ppsspp/configs/backupforromsfolder/ppsspp/PSP/SYSTEM/ppsspp.ini.2021.sdl.${UNIT} Arkbuild/opt/ppsspp-2021/backupforromsfolder/ppsspp/PSP/SYSTEM/ppsspp.ini.sdl
sudo cp -L emulators/ppsspp/controls.ini.${UNIT} Arkbuild/opt/ppsspp-2021/backupforromsfolder/ppsspp/PSP/SYSTEM/controls.ini
sudo cp -L emulators/ppsspp/ppsspp.ini.2021.${UNIT} Arkbuild/opt/ppsspp-2021/backupforromsfolder/ppsspp/PSP/SYSTEM/ppsspp.ini
